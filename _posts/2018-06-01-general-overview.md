...
---
The graphical user interface of Cytosplore Viewer consists of three main components: **A** [The Hierarchy Viewer](/documentation/hierarchyview), **B** [The Map Viewer](/documentation/mapview) and **C** [The Differential Expression Viewer](/documentation/diffexpressionviewer).

![Cytosplore Viewer Overview image][overview_image]{:width="1400px"}
...
[overview_image]: {{ site.baseurl }}/assets/documentation/overview_app.png "Cytosplore Viewer Overview"
